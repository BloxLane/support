...
const config = {
  ...
  tagline: "For when you need that *extra* push in BloxLane",
  favicon: "img/favicon.ico",

  // Set the production url of your site here
  url: "https://support.bloxlane.devs-stuff.com",
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: "Roblox Group",
                href: "https://www.roblox.com/groups/32879520/BloxLane-Shopping#!/about",
              },
              {
                label: "Discord",
          ...
          },
          {
            ...
            items: [
              {
                label: "Organization",
                href: "https://github.com/AirRhyme",
              },
              {
                label: "Support Repository",
                href: "https://github.com/AirRhyme/support",
              },
            ],
          },
        ],
