...
This guide outlines all of the necessary information about the promotion process at BloxLane.
...
> 4.   Store Managers wishing to receive a promotion should remain active in the BloxLane Discord server. Talking in channels and attending events does help.
...
Some BloxLane ranks have cooldowns. A cooldown refers to a specific duration during which a player is ineligible to receive a promotion.
...
| Board of Director: 1 month |
| Assistant Executive Board: 2 months |
...
| Store Intern: 800 |
| Team Leader: 1,000 |
| Department Leader: 1,100 |
| Assistant Store Manager: 1,250 |
| Store Manager: 1,500 |
| Store Director: 4,000 |
| Board of Directors: 6,500 |
| Executive Assistant: 10,000 |
| Executive Board: 12,000 |
